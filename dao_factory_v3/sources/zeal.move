...
module dao_factory::zeal {
    ...
    public(friend) fun initialize(
        ...
        while (i < len) {
            let staking_token_addr = *vector::borrow(&staking_tokens, i);
    ...
    public entry fun vote(
        ...
        // FIX (audit10 M3 + audit10 #2): consolidated in legacy.
        legacy::assert_authorized_voter(dao_address, voter_addr, ve_token_obj);
